 ...
 */
public final class ScriptEngineHandler
{
    ...
    private final CommandParseHandler commandParseHandler;
    private final VariableHandler variableHandler;

    ScriptEngineHandler(BundleHandler bundleHandler, 
                        LauncherHandler launcherHandler,
                        CommandParseHandler commandParseHandler,
    ...
    public final void restart()
    {
        ...
        try
        {
            ...
            String toEval = "var console = { __noSuchMethod__: function() { this.handler.apply(arguments[0], Java.to(Array.prototype.slice.call(arguments, 1), Java.type('java.lang.Object[]'))).runCommand(); } };";
            engine.eval(toEval);
