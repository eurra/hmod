...
{
    private BundleLoader bundleHandler;
    private ScriptLauncher scriptEngineHandler;

    public void setBundleHandler(BundleLoader bundleHandler)
    {
        this.bundleHandler = bundleHandler;
    }

    public void setScriptEngineHandler(ScriptLauncher scriptEngineHandler)
    {
