 ...
 */
public final class CommandParseHandler
{
    ...
    private static class CustomArgs implements CommandArgs
    {
        ...
        private final TextProcessorHandler textProcessorHandler;

        public CustomArgs(Object[] args, TextProcessorHandler textProcessorHandler)
        {
            this.args = args;
    ...
    CommandParseHandler(CommandHandler commandHandler,
